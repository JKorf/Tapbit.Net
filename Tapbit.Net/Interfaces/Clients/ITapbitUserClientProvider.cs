namespace Tapbit.Net.Interfaces.Clients
{
    ...
    /// </summary>
    public interface ITapbitUserClientProvider
    {
        /// <summary>
        ...
        void InitializeUserClient(string userIdentifier, TapbitCredentials credentials, TapbitEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        ITapbitRestClient GetRestClient(string userIdentifier, TapbitCredentials? credentials = null, TapbitEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        ITapbitSocketClient GetSocketClient(string userIdentifier, TapbitCredentials? credentials = null, TapbitEnvironment? environment = null);
    }
}