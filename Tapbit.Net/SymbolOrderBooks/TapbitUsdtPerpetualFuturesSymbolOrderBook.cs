...
namespace Tapbit.Net.SymbolOrderBooks
{
    ...
    /// </summary>
    public class TapbitUsdtPerpetualFuturesSymbolOrderBook : SymbolOrderBook
    {
        ...
        public TapbitUsdtPerpetualFuturesSymbolOrderBook(string symbol, Action<TapbitOrderBookOptions>? optionsDelegate = null)
        ...
        public TapbitUsdtPerpetualFuturesSymbolOrderBook(
            string symbol,
            Action<TapbitOrderBookOptions>? optionsDelegate,
            ILoggerFactory? logger,
            ITapbitRestClient? restClient,
            ITapbitSocketClient? socketClient) : base(logger, "Tapbit", "UsdtPerpetualFutures", symbol)
        {
