...
{
    /// <summary>
    /// Client providing access to the Tapbit UsdtPerpetualFutures websocket Api
    /// </summary>
    internal partial class TapbitSocketClientUsdtPerpetualFuturesApi : SocketApiClient<TapbitEnvironment, TapbitAuthenticationProvider, TapbitCredentials>, ITapbitSocketClientUsdtPerpetualFuturesApi
    {
        #region fields
        ...
        /// ctor
        /// </summary>
        internal TapbitSocketClientUsdtPerpetualFuturesApi(ILoggerFactory? loggerFactory, TapbitSocketOptions options) :
            base(loggerFactory, TapbitExchange.Metadata.Id, options.Environment.SocketClientAddress!, options, options.UsdtPerpetualFuturesOptions)
        {
        }
        #endregion
        ...
        /// <inheritdoc />
        public ITapbitSocketClientUsdtPerpetualFuturesApiShared SharedClient => this;
