...
namespace Tapbit.Net.UnitTests
{
    ...
    internal class SharedRestIntegrationTests
    {
        ...
        //private ITapbitRestClientSpotApiShared GetSpotRestClient()
        //{
        //    var collection = new ServiceCollection();
        //    collection.AddTapbit(x => x.Rest.OutputOriginalData = true);
        ...
        //    return sp.GetRequiredService<ITapbitRestClient>().SpotApi.SharedClient;
        //}

        //private ITapbitRestClientFuturesApiShared GetFuturesRestClient()
        //{
        //    var collection = new ServiceCollection();
        //    collection.AddTapbit(x => x.Rest.OutputOriginalData = true);
        //    collection.AddLogging(x =>
        ...
        //    });
        //    var sp = collection.BuildServiceProvider();
        //    return sp.GetRequiredService<ITapbitRestClient>().FuturesApi.SharedClient;
        //}
