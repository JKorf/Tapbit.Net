...
namespace Tapbit.Net.UnitTests.Documentation
{
    [TestFixture]
    public class AiExampleCompileTests
    {
        ...
        private static string GetRepositoryRoot()
        {
            ...
            {
                if (File.Exists(Path.Combine(directory.FullName, "Tapbit.Net.sln")))
                    return directory.FullName;

                directory = directory.Parent;
            }

            throw new DirectoryNotFoundException("Could not find repository root containing Tapbit.Net.sln.");
        }
    }
}
